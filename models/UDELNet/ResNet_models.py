...
from models.UDELNet.ResNet import B2_ResNet, UNetConvBlock, UNetUpBlock
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
from torch.nn import Parameter, Softmax
import torch.nn.functional as F
from models.UDELNet.HolisticAttention import HA
...
class Saliency_feat_encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # x2_2 = self.HA(sal_init.sigmoid(), x2)  ##################  HA  模块
        x2_2= x2
